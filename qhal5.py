...
owner=["u22ed21bd97a4291726fa53b756ce2f01","uab9e9a4220733668859368b2a68285fb"]
admin=["u22ed21bd97a4291726fa53b756ce2f01","uab9e9a4220733668859368b2a68285fb"]
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentMetadata = {'mid': "u22ed21bd97a4291726fa53b756ce2f01"}
                kr1.sendMessage(msg)
                kr1.sendText(msg.to,'❂➣ This My Creator  􀜁􀄯􏿿')
...
#==============================================================================#
            ...
            elif msg.text in ["Syn","Synd","syn","synd"]: #Panggil Semua Bot
                if msg.from_ in owner:
                    G = kr1.getGroup(msg.to)
                    ginfo = kr1.getGroup(msg.to)
                    G.preventJoinByTicket = False
            ...
            elif "Synoff" in msg.text:#keluar semua bots
                if msg.from_ in owner:
                    if msg.toType == 2:
                        ginfo = kr1.getGroup(msg.to)
                        ...
                        try:
                            ...
                            pass
            elif "Syn bye" in msg.text:#keluar bot kecuali bot induk
                if msg.from_ in owner:
                    if msg.toType == 2:
                        ginfo = kr1.getGroup(msg.to)
                        ginfo = kr2.getGroup(msg.to)
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          kr1.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ՏվղժíϲɑԵҽ")
          print "Like"
        except:
          pass
      else:
