...
ql = QHAL.LINE()
ql.login(token='EqPAqh63naWyqEcmjCE5.eRBLOvyKSiRM2eiKYtTSjq.1+RvFCq2tqGJAR2LDJ30HewnB3tXGLSeol1bReqfGys=')
ql.loginResult()

ki = QHAL.LINE()
ki.login(token='EqMx2Mvb0XZFihCOHdY5.x71w2igoRqWv9dRC14Wbfq.oSxfr6Mjs+0nd6naA5IIhBxICBXS6Ef8Mp2SvRYB95E=')
ki.loginResult()

ki2 = QHAL.LINE()
ki2.login(token='EpE6Ozvv1J9TlDEKUcSc.Jpppb936q5lRNhfhLJ8xZa.KLAG4vs+TdscD4E/6dGRy/kBun1x99742BpWNCiusdg=')
ki2.loginResult()

ki3 = QHAL.LINE()
ki3.login(token='Epq8BL36R7XVJKoHz6Ae.LwGH53v0cASX0C1GZ/iLlG.lP8Aok0JZ59eG7poqbcNkWlDf+mFhHZnMDzsHE1lT/o=')
ki3.loginResult()
...
╠══════════════
║ Chiqal Adiksa
║ http://line.me/ti/p/chiqaladiksa
╠══════════════
║╔═════════════
║╠❂🔑  [google] (text)
║╠❂🔑  [playstore] (text)
...
owner =["u5e74fed229d5fe5335e2b15935608968"]
admin=["u5e74fed229d5fe5335e2b15935608968","ufd446574ba860923aeb438c933c836ce","ubde4ce5d7ed9128240c6d17a19931352","u5fbd56d8818ead0c15f43adcd78c0115","ufafdbacbff38226d151940789db301d7","u1419826892f933d1280d8f59a485a929","u0897b84fe18d159acfee8682e15accfa"]
            ...
            try:
                if cctv['cyduk'][op.param1]==True:
                    if op.param1 in cctv['point']:
                        Name = ql.getContact(op.param2).displayName
                        if Name in cctv['sidermem'][op.param1]:
                            pass
                        else:
                            cctv['sidermem'][op.param1] += "\n~ " + Name
                            zxn=["Hai "," Hai kak ","Halloo ","Hmmm ","Turun dong ","Halo kak "]
                            say = random.choice(zxn) +" "+ Name
                            ql.sendText(op.param1, say)
...
#                pass
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Don't Tag Me! iam Bussy!, ",cName + "Ada perlu apa, ?" ,cName + " pc aja klo urgent! sedang sibuk," , cName + "DONT TAG ME" , cName + "Lu sange ??" , cName + "Apa ??" , cName +  "[Auto Respons]" , cName + "Hadiirrr"]
                ...
                if wait['invite'] == True:
                     ...
                     for s in groups.members:
                         if _name in s.displayName:
                             ki.sendText(msg.to, _name + " Berada DiGrup Ini")
                         else:
            ...
            if msg.contentType == 13:
                if wait["winvite"] == True:
                    if msg.from_ in admin or owner:
                        ...
                        for s in groups.members:
                            if _name in s.displayName:
                                ki.sendText(msg.to,"-> " + _name + " ada di room ini")
                                break
                            elif invite in wait["blacklist"]:
                                ki.sendText(msg.to,"Maaf, " + _name + " kena Blacklist")
                                ki.sendText(msg.to,"hubungi owner kami ya !, \n➡Unban: " + invite)
                                break
                            else:
                                targets.append(invite)
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ki.findAndAddContactsByMid(target)
                                    ki.inviteIntoGroup(msg.to,[target])
                                    ki.sendText(msg.to,"Selesai di Invite : \n➡" + _name)
                                    wait["winvite"] = False
                                    break
                                except:
                                    try:
                    ...
                    if msg.from_ in admin or owner:
                        ...
                        for s in groups.members:
                            if _name in s.displayName:
                                ki2.sendText(msg.to,"-> " + _name + " ada di room ini")
                                break
                            elif invite in wait["blacklist"]:
                                ki2.sendText(msg.to,"Maaf, " + _name + " kena Blacklist")
                                ki2.sendText(msg.to,"hubungi owner kami ya !, \n➡Unban: " + invite)
                                break
                            else:
                                targets.append(invite)
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    ki2.sendText(msg.to,"Selesai di Invite : \n➡" + _name)
                                    wait["winvite"] = False
                                    break
                                except:
                                    try:
                                        ...
                                        ki2.sendText(msg.to,"Negative, Error detected")
                                        wait["winvite"] = False
                                        break
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                ql.sendText(msg.to,"My Name:" + h.displayName)
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        ql.sendText(msg.to,"αυ��σʝσιи ѕєт тσ σff")
                    else:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u5e74fed229d5fe5335e2b15935608968"}
                ql.sendMessage(msg)
                ...
                if wait["commentBlack"] == {}:
                    ...
                    for mi_d in wait["commentBlack"]:
                        mc += "ãƒ»" +ql.getContact(mi_d).displayName + "\n"
...
#========================== FOR COMMAND BOT FINISHED =============================#
         #----------------Fungsi Join Group Start-----------------------#
                        ...
                        ql.updateGroup(G)
                        invsend = 0
                        Ticket = ql.reissueGroupTicket(msg.to)
                        ...
                        time.sleep(0.001)
                        H = ql.getGroup(msg.to)
                        ginfo = ql.getGroup(msg.to)
                        H.preventJoinByTicket = True
                        ki.updateGroup(H)
                        ki.sendText(msg.to,"Hallo...!!! " + str(ginfo.name) + "\n🍀☺🍀☺🍀☺I LOVE♥ YOUR ╔╗╔╦╗╦ ╦  ╦═╗\n╚╗���║║║ ║  ╠╣\n╚╝╝╝╝╩ ╩╝╩═╝")
                        print "Semua Sudah Lengkap"
            elif msg.text in ["syn,"]:
              #if msg.from_ in owner or admin:
                        G = ql.getGroup(msg.to)
                        ginfo = ql.getGroup(msg.to)
                        G.preventJoinByTicket = False
...
#==============================================================================#
                ...
                if msg.from_ in admin:
                    wait["invite"] = True
                    ki2.sendText(msg.to,"Kirim Contact")
...
#==============================================================================#
                ...
                if wait["Lv"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ql.sendText(msg.to,"already oғғ")
#==============================================================================#
            elif ".aku tuh gk bisa di giniin" in msg.text:
				if msg.toType == 2:
					if msg.toType == 2:
						print "ok"
						_name = msg.text.replace(".aku tuh gk bisa di giniin","")
						gs = ql.getGroup(msg.to)
						gs = ql.getGroup(msg.to)
						gs = ql.getGroup(msg.to)
						ki.sendText(msg.to,"Papaayyy")
						ql.sendText(msg.to,"Group Anjing")
						targets = []
						for g in gs.members:
						...
						if targets == []:
							...
							for target in targets:
								try:
									klist=[ql,ql,ki,ki,ki2,ki2,ki3,ki3]
            ...
            elif "salamikum" in msg.text:
              if msg.from_ in owner:
                ql.sendText(msg.to,"السَّلاَمُ عَلَيْكُمْ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ")
                ki.sendText(msg.to,"Assalamu'alaikum")
                ki2.sendText(msg.to,"وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِوَبَرَكَاتُهُ")
                ki3.sendText(msg.to,"Wa'alaikumsallam.Wr,Wb")
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("salamikum","")
                    gs = ki.getGroup(msg.to)
                    ki2.sendText(msg.to,"maaf kalo gak sopan")
                    ki3.sendText(msg.to,"Qo salamnya gak ada yang jawab ya..!!")
                    ki.sendText(msg.to,"hehehhehe")
                    targets = []
                    for g in gs.members:
                        if _name in g.displayName:
                            targets.append(g.mid)
...
#--------------------------
               ...
               if msg.from_ in admin:
                ...
                ql.sendText(msg.to,"Ready to check")
#--------------------------
            elif "Sider off" in msg.text:
               if msg.from_ in admin:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    ql.sendText(msg.to, cctv['sidermem'][msg.to])
                else:
                    ql.sendText(msg.to, "Heh belom di Set")
...
#==============================================================================#
            ...
            elif msg.text in ["syn glist"]:
                gid = ki2.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "%s\n" % (ki2.getGroup(i).name +" ? ["+str(len(kr.getGroup(i).members))+"]")
                ki2.sendText(msg.to,"-- List Groups --\n\n"+ h +"\nTotal groups =" +" ["+str(len(gid))+"]")
...
#==============================================================================#
                ...
                if msg.from_ in admin:
                    ...
                    ql.sendImageWithURL(msg.to, url)
                    ql.sendImageWithURL(msg.to, url1)
                    ql.sendImageWithURL(msg.to, url2)
                    ql.sendImageWithURL(msg.to, url3)
                    ql.sendImageWithURL(msg.to, url4)
                    ql.sendImageWithURL(msg.to, url5)
                    ql.sendImageWithURL(msg.to, url6)
                    ql.sendImageWithURL(msg.to, url7)
...
#================================ QHAL SCRIPT STARTED ==============================================#
            ...
            elif msg.text in ["GL2"]:  
                gruplist = ki2.getGroupIdsJoined()
                kontak = ki2.getGroups(gruplist)
                num=1
                msgs="═════════List Grup═════════"
                for ids in kontak:
                    msgs+="\n[%i] %s" % (num, ids.name)
            ...
            elif msg.text in ["GL3"]:  
                gruplist = ki3.getGroupIdsJoined()
                kontak = ki3.getGroups(gruplist)
                num=1
                msgs="═════════List Grup═════════"
                for ids in kontak:
                    msgs+="\n[%i] %s" % (num, ids.name)
            ...
            elif msg.text in ["GL4"]:  
                gruplist = ki4.getGroupIdsJoined()
                kontak = ki4.getGroups(gruplist)
                num=1
                msgs="═════════List Grup═════════"
                for ids in kontak:
                    msgs+="\n[%i] %s" % (num, ids.name)
            ...
            elif msg.text in ["GL5"]:  
                gruplist = ki5.getGroupIdsJoined()
                kontak = ki5.getGroups(gruplist)
                num=1
                msgs="═════════List Grup═════════"
                for ids in kontak:
                    msgs+="\n[%i] %s" % (num, ids.name)
                ...
                if msg.from_ in owner:
                    ...
                    if gid == "":
                        ...
                        try:
                            ...
                            ki.sendText(msg.to,"succes di invite boss, silahkan masuk...!!")
                        except:
                            ki.sendText(msg.to,"Mungkin saya tidak di dalaam grup itu")
                            
            elif "asupka2 " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("asupka2 ","")
                    if gid == "":
                        ...
                        try:
                            ...
                            ki2.sendText(msg.to,"succes di invite boss, silahkan masuk...!!")
                        except:
                            ki2.sendText(msg.to,"Mungkin saya tidak di dalaam grup itu")
                            
            elif "asupka3 " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("asupka3 ","")
                    if gid == "":
                        ...
                        try:
                            ...
                            ki3.sendText(msg.to,"succes di invite boss, silahkan masuk...!!")
                        except:
                            ki3.sendText(msg.to,"Mungkin saya tidak di dalaam grup itu")
                            
            elif "asupka4 " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("asupka4 ","")
                    if gid == "":
                        ...
                        try:
                            ...
                            ki4.sendText(msg.to,"succes di invite boss, silahkan masuk...!!")
                        except:
                            ki4.sendText(msg.to,"Mungkin saya tidak di dalaam grup itu")
                            
            elif "asupka5 " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("asupka5 ","")
                    if gid == "":
                        ...
                        try:
                            ...
                            ki5.sendText(msg.to,"succes di invite boss, silahkan masuk...!!")
                        except:
...
#=================================QHAL SCRIPT FINISHED =============================================#
       #-------------Fungsi Respon Start---------------------#
              ...
              #if msg.from_ in admin:
                ki.sendText(msg.to,"Q")
                ki2.sendText(msg.to,"H")
                ki3.sendText(msg.to,"A")
      ...
      #-------------Fungsi Respon Finish---------------------#
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ql.sendText(msg.to,"There was no blacklist user")   
                        return
