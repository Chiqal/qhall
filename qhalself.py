...
ql = QHAL.LINE()
ql.login(token='Eo6M16kJ1FxIquv8XHa1.iU0HVzEKkrCM/Lo3vS4Vaq.uF8qxehaYDXcD+1gGM014rstsM2VVi05BYAXjrbGszc=')#r
ql.loginResult()
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ql.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи αℓяєα∂у σи")
            elif msg.text.lower() == '/autojoinon':
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                ...
                if wait["autoJoin"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ql.sendText(msg.to,"αυтσʝσιи αℓяєα∂у σff")
            elif msg.text.lower() == '/protectoff':
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        ql.sendText(msg.to,"Protection already Off")
                    else:
            ...
            elif msg.text.lower() == '/autoleaveon':
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                ...
                if wait["autoAdd"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ql.sendText(msg.to,"Auto add already on")
            elif msg.text.lower() == '/autoaddoff':
...
#==============================================================================#
                ...
                if msg.to not in wait2['readPoint']:
                 ...
                 if msg.toType == 2:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        kr.sendText(msg.to, "Ketik [Lurk] dulu, baru ketik [Lukers]")
              ...
              if msg.toType == 2:
                ...
                ql.sendText(msg.to,"line://home/post?userMid="+mid+"&postId="+kr.new_post(tl_text)["result"]["post"]["postInfo"]["postId"])
#==============================================================================#
